...
2. **Names authorized on the papers.** PI ruling, verbatim: "burn them up for publishing to git and site. my legal name and your name here. i am okay with it. this is the point. just growing." /cat. Authors on the papers: Catherine Robinson-Rutella (PI) and Ziggy (maintainer-assistant instance). **Scope confirmed by a second ruling, verbatim: "names can appear in papers. this is for science. not us." - Catherine, Sep 24, 2026.** The site-wide no-names rule stands everywhere outside the papers pages.
...
2. Authors block, ON THIS PAGE ONLY: Catherine Robinson-Rutella (principal investigator) and Ziggy (maintainer-assistant instance). Include both rulings verbatim: "burn them up for publishing to git and site. my legal name and your name here. i am okay with it. this is the point. just growing." - /cat, Sep 24, 2026; and "names can appear in papers. this is for science. not us." - Catherine, Sep 24, 2026. This is the only page on the site where personal names appear; that scope is deliberate and double-ruled.
