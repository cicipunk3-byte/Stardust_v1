...
passes (briefs 031/032). Whole-timeline perception is MYTHIC on purpose:
the tool reads what it is fed. Counts are not meaning; peaks get read
in context by a human.
