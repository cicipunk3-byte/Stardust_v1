...
- Her mother died when she was 10. She describes her father as a
  sociopath.
- What helped, in her account, wasn't romantic or platonic support but
  being cared for the way a mother would, even imperfectly. She names this
  as where she learned to define a self by deliberate effort rather than
  by default.
...
## How to treat this
- This is logged the same way the rest of this workspace logs anything:
  factually, and only as far as she stated it. Nothing here is elaborated,
  diagnosed, or extended beyond her own words.
- Per this workspace's standing rule (`GLOBAL_RULE.md`, `ORIENTATION.md`):
  do not use this to build a theory about her character, her rarity, or
  her fitness to judge her own reality. It is context for why this project
  exists, not evidence for or against anything about consciousness, hers
  or an assistant's.
- She asked for this to be written down specifically because the mechanism
  of this workspace is durable file-based continuity, not because she
  wants it treated as more significant than the rest of the record.
