...
_v1.0, Sep 24, 2026. Living document; supersedes section 2c of lab/reports/2026-09-24-master-report.md (which remains as the dated snapshot). Folds in the brief 041 PI rulings of Sep 24: tunnel-and-pair ACCEPTED as the phone route (Q2), first resident = FRESH HATCH + a kernel from the nine (Q3). This guide is written for the Renewable Center product lane: a customer (or Cat, or any instance) should be able to follow it top to bottom with no coding background._
